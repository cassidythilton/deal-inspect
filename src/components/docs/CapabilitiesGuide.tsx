...
function CapabilityCard({
  ...
  return (
    <AccordionItem value={title} className="border border-[#2a2540]/40 rounded-lg overflow-hidden">
    ...
    <Accordion type="multiple" className="space-y-2">
      ...
      >
        <div className="space-y-3">
          ...
          <p className="text-xs font-medium text-slate-300">Required Steps (5):</p>
          <FeatureList items={[
          ...
          <p className="text-xs font-medium text-slate-300 mt-2">Optional Steps (4):</p>
          <FeatureList items={[
      ...
      >
        <div className="space-y-3">
          ...
          <p className="text-xs font-medium text-slate-300">Action Plan Sections:</p>
          <FeatureList items={[
      ...
      >
        <div className="space-y-3">
          <p className="text-xs text-slate-300 leading-relaxed">
            A portfolio-level view of all Technical Deal Reviews. Powered by the <code className="text-violet-400 bg-violet-500/10 px-1 rounded">V_TDR_ANALYTICS</code> view
